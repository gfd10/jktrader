...
class Kiwoom(QAxWidget):
    ...
    def _receive_tr_data(self, screen_no, rqname, trcode, record_name, next, unused1, unused2, unused3, unused4):
        ...
        if rqname == "opt10081_req": #opt10081 - 주식일봉조회 값 Request에 대한 응답이면 _opt10081 함수 호출
    ...
    def _comm_get_data(self, code, real_type, field_name, index, item_name):
        ...
        # test = self.dynamicCall("GetCommData(QString, QString, int, QString)", "opt0001", "주식기본정보", 0, "현재가")
        # print(test)
    ...
    def _opw00018(self, rqname, trcode):
        ...
        for i in range(rows):
            ...
            self.opw00018_output['multi'].append([strip_num, name, quantity, purchase_price, current_price, eval_profit_loss_price,
                                                  earning_rate])
